...
// helper
const fakeUsers: string[] = ['Flex Kubin', 'Attila Hun', 'Childish Gambino', 'Ken M', 'Margarida', 'Rosalia', 'Leihla P', 'Andrea']
...
const fakeUserTableData: UserTableData[] = fakeUsers.map((name: string): UserTableData => ({
  name,
  id: randomHash(),
