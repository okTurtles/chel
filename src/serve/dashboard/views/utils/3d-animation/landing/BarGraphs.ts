...
export default class BarGraphs extends Group {
  constructor ({
    ...
    for (let i = 0; i < pairCount; i++) {
      ...
      const mesh1: any = new CombineWithEdge({ mesh: new Mesh(geo1, mat1), edgeColor: '#414141' })
      const mesh2: any = new CombineWithEdge({ mesh: new Mesh(geo2, mat2), edgeColor: '#414141' })
