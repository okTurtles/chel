...
export function LTags (...tags: string[]): {[key: string]: string} {
...
function sanitize (inputString: string): string {
...
Vue.component('i18n', {
  ...
  render: function (h: (tag: string, data: unknown, content?: unknown) => unknown, context: { children: Array<{ text: string }>; props: { args?: Record<string, unknown>; tag: string }; data: { attrs: { target?: string; rel?: string }; domProps?: { innerHTML?: string } } }) {
