...
// whose embedded addon has gone missing, and sending a Windows or macOS user
// after their libc would be a wrong diagnosis. The platform is a parameter so
// that both branches stay testable from any host.
//
