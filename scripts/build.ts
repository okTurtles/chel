...
const options = {
  ...
  external: [
    ...
    'npm:@chelonia/lib@1.1.0/functions',
    'npm:@chelonia/lib@1.1.0/db',
    'npm:@chelonia/lib@1.1.0/SPMessage',
    'npm:@chelonia/lib@1.1.0/presets',
    'npm:@chelonia/lib@1.1.0',
    'npm:@chelonia/lib@1.1.0/pubsub',
    'npm:@chelonia/lib@1.1.0/utils',
